function [x_sol, time, samp_list, scaling] = total_degree_sampling(N,D,J,An,Un_sq,no_samp,y,type)
...
% An_list (d*N*(J+1)): list of small grid matrices An for different d.
% Un_sq: Left singular vector matrix of An with square entries
% type: unif(uniform sampling)/lev(tensor product lev sampling)/alev(total degree lev sampling)
% Output: 
...
col_ind = sub_tp_idx_set(D,J,'total degree')+1;
